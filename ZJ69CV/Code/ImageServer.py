...
class ImageServer(object):
    def __init__(self, imgSize=[250, 250], frameFraction=0.25, initialization='box', color=False):
        self.origLandmarks = []
        self.filenames = []
        self.mirrors = []
    ...
    def LoadImages(self):
        ...
        for i in range(len(self.filenames)):
            ...
            import imageio
            img = imageio.imread(self.filenames[i])
            if self.color:
    ...
    def NormalizeImages(self, imageServer=None):
        ...
        if self.color:
            ...
            plt.imshow(stdDevImg[:,:,0], cmap='gray')
            #plt.cm.gray
